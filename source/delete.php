...
/*PAGE setzen*/
$PAGE->set_url('/mod/apeinsdrei/delete.php', array('id' => $cm->id,'resourceid' => $_GET['resourceid']));
...
echo html_writer::link(new moodle_url('../apeinsdrei/deleteaccept.php', array('id' => $cm->id, 'resourceid' => $resID, 'resname'=> $resName)), 'bestätigen', array('class' => 'btn btn-secondary'));
