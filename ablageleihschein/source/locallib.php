...
/**
 * Internal library of functions for module ablageleihschein
 *
 * All the ablageleihschein specific functions, needed to implement the module
...
function ablageleihschein_do_something_useful(array $things) {
    return new stdClass();
}

function ablageleihschein_get_process_definition_id($processKey) {
	global $processDefinitionsApiInstance;
...
function ablageleihschein_start_process($process_definition_id, $business_key) {
	global $processInstancesApiInstance;
...
function ablageleihschein_check_for_input_required($process_instance_id) {
	global $tasksApiInstance;
	try {
...
function ablageleihschein_answer_input_required($task_id, $process_definition_id, $value1, $value2) {
	global $formsApiInstance;
...
function ablageleihschein_get_process_instance_status($process_instance_id) {
	global $processInstancesApiInstance;
