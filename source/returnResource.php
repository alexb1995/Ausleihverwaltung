...
$PAGE->set_url('/mod/checkdeadline/returnResource.php', array('id'=>$cm->id, 'resourceid'=>$_GET['resourceid']));
...
if(strpos($strUrl, 'resourceid=')){
    ...
    echo nl2br("\n");
    // Navigation
    echo html_writer::link(new moodle_url('../checkdeadline/saveDefect.php', array('id'=>$cm->id, 'resourceid'=>$resourceid)), 'Zurück: Schaden vermerken', array('class'=>'btn btn-secondary'));
    ...
    echo nl2br("\n");
    // Navigation
    echo html_writer::link(new moodle_url('../checkdeadline/saveDefect.php', array('id'=>$cm->id, 'resourceid'=>$fm_resourceid)), 'Zurück: Schaden vermerken', array('class'=>'btn btn-secondary'));
    echo html_writer::link(new moodle_url('/course/view.php', array('id'=>2)), 'Weiter: Home', array('class'=>'btn btn-secondary'));
};
